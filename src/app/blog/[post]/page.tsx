  ...
  return (
    <>
      <div className="w-full h-[400px] lg:h-[500px] max-w-[1440px] relative">
        <div className="w-full h-full absolute bg-gradient-to-b object-center from-[#DFDFDF50] via-[#89898950] to-[#5A5A5A50]">
          <Image
            src="/image/fros-roman-image-1440w.png"
            alt="Fros Venture Roman Image"
            fill
            sizes="(max-width: 480px) 50vw, (max-width: 976px) 70vw, 100vw"
